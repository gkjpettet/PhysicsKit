...
Inherits PhysicsKit.Polygon
	#tag Method, Flags = &h0, Description = 
		Sub Constructor(point1 As PhysicsKit.Vector2, point2 As PhysicsKit.Vector2, point3 As PhysicsKit.Vector2)
		  ///
		  ' Full constructor.
		  '
	...
	#tag Method, Flags = &h0
		Function Contains(point As PhysicsKit.Vector2, transform As PhysicsKit.Transform) As Boolean
		  ...
		  Var p3 As Vector2 = Self.Vertices(2)
		  
		  // Create a vector representing edge ab.
		  Var ab As Vector2 = p1.Towards(p2)
		  
		  // Create a vector representing edge ac.
		  Var ac As Vector2 = p1.Towards(p3)
		  
		  // Create a vector from a to the point.
		  Var pa As Vector2 = p1.towards(p)
