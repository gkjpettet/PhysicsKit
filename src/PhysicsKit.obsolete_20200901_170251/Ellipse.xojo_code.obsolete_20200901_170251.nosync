...
Implements PhysicsKit.Convex
	...
	#tag Method, Flags = &h0, Description = 
		Shared Function GetFarthestPointOnBoundedEllipse(xmin As Double, xmax As Double, a As Double, b As Double, point As PhysicsKit.Vector2) As PhysicsKit.Vector2
		  ///
		  ...
		  Var q As Vector2 = New Vector2(px, py)
	...
	#tag Method, Flags = &h0
		Shared Function GetFarthestPointOnEllipse(a As Double, b As Double, point As PhysicsKit.Vector2) As PhysicsKit.Vector2
		  ///
	...
	#tag Method, Flags = &h0
		Function GetRadius(center As PhysicsKit.Vector2) As Double
		  ...
		  Var p As Vector2 = center.Difference(Self.Center).InverseRotate(Self.Rotation)
		  
		  // Get the farthest point.
		  Var fp As Vector2 = Ellipse.GetFarthestPointOnEllipse(Self.HalfWidth, Self.HalfHeight, p)
	...
	#tag Method, Flags = &h21
		Private Shared Function GetSquaredDistance(a2 As Double, ba As Double, x As Double, q As PhysicsKit.Vector2, p As PhysicsKit.Vector2) As Double
		  ///
