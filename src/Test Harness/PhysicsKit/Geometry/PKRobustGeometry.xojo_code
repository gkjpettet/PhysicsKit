...
Protected Class PKRobustGeometry
	...
	#tag Method, Flags = &h0, Description = 
		Shared Function GetLocation(point As PKVector2, linePoint1 As PKVector2, linePoint2 As PKVector2) As Double
		  ...
		  ' Computes the same value with `Segment.GetLocation(PKVector2, PKVector2, PKVector2)` but with
		  ' enough precision so the sign of the result is correct for any PKVector2s pa, pb, pc.
		  ...
		  ' to `Segment.GetLocation(PKVector2, PKVector2, PKVector2)` but in the hard cases can be 5-25 times slower.
		  '
	...
	#tag Method, Flags = &h0, Description = 54686520657874656E64656420707265636973696F6E20696D706C656D656E746174696F6E20666F722074686520736964652D6F662D6C696E6520746573742E
		Shared Function GetLocationAdaptive(point As PKVector2, linePoint1 As PKVector2, linePoint2 As PKVector2, detSum As Double) As Double
		  ///
