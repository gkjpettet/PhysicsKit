#tag Class
Protected Class PKAABB
Implements  PKTranslatable
	#tag Method, Flags = &h0, Description = 46756C6C20636F6E7374727563746F722E
		Sub Constructor(radius As Double)
		  ///
		  ' Full constructor.
		  '
		  ' - Parameter radius: The radius of a circle fitting inside a PKAABB.
		  ///
	...
	#tag Method, Flags = &h0, Description = 436F707920636F6E7374727563746F722E
		Sub Constructor(aabb As PKAABB)
		  ///
		  ' Copy constructor.
		  '
		  ' - Parameter aabb: The PKAABB to copy.
		  ///
	...
	#tag Method, Flags = &h0, Description = 4372656174657320616E204141424220666F72206120636972636C6520776974682074686520676976656E2063656E74657220616E64207261646975732E
		Sub Constructor(center As PKVector2, radius As Double)
		  ///
		  ' Full constructor.
		  ' Creates a PKAABB for a circle with the given center and radius.
		  '
	...
	#tag Method, Flags = &h0, Description = 46756C6C20636F6E7374727563746F722E
		Sub Constructor(min As PKVector2, max As PKVector2)
		  ///
		  ' Full constructor.
		  '
	...
	#tag Method, Flags = &h0
		Function Contains(x As Double, y As Double) As Boolean
		  ///
		  ' Returns True if the given point's coordinates are contained within this PKAABB.
		  '
	...
	#tag Method, Flags = &h0
		Function Contains(aabb As PKAABB) As Boolean
		  ///
		  ' Returns True if the given PKAABB is contained within this PKAABB.
		  '
		  ' - Parameter aabb: The PKAABB to test.
		  ' - Returns: Boolean.
		  ///
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320547275652069662074686520676976656E20706F696E7420697320636F6E7461696E65642077697468696E207468697320414142422E
		Function Contains(point As PKVector2) As Boolean
		  ///
		  ' Returns True if the given point is contained within this PKAABB.
		  '
	...
	#tag Method, Flags = &h0, Description = 52657475726E73206120636F7079206F66207468697320414142422E
		Function Copy() As PKAABB
		  ///
		  ' Returns a copy of this PKAABB.
		  '
		  ' - Returns: A new PKAABB.
		  ///
		  
		  Return New PKAABB(Self)
	...
	#tag Method, Flags = &h0, Description = 43726561746573207468652076616C6964204141424220646566696E6564206279207468652074776F20706F696E74733A204128706F696E7431782C20706F696E7431792920616E64204228706F696E7432782C20706F696E743279292E
		Shared Function CreateAABBFromPoints(point1X As Double, point1Y As Double, point2X As Double, point2Y As Double) As PKAABB
		  ///
		  ' Creates the valid PKAABB defined by the two points: A(point1x, point1y) and B(point2x, point2y).
		  '
		  ...
		  '
		  ' - Returns: The one and only one valid PKAABB formed by A and B.
		  ///
		  ...
		  Return New PKAABB(point1x, point1y, point2x, point2y)
	...
	#tag Method, Flags = &h0, Description = 43726561746573207468652076616C6964204141424220646566696E6564206279207468652074776F20706F696E74732060706F696E74316020616E642060706F696E7432602E
		Shared Function CreateAABBFromPoints(point1 As PKVector2, point2 As PKVector2) As PKAABB
		  ///
		  ' Creates the valid PKAABB defined by the two points `point1` and `point2`.
		  '
		  ' - Parameter point1: The first point.
		  ' - Parameter point2: The second point.
		  '
		  ' - Returns: The one and only one valid PKAABB formed by 'point1' and 'point2'.
		  ///
	...
	#tag Method, Flags = &h0, Description = 457870616E6473207468697320414142422062792068616C662074686520676976656E20657870616E73696F6E20696E206561636820646972656374696F6E20616E64207468656E2072657475726E73207468697320414142422E
		Function Expand(expansion As Double) As PKAABB
		  ///
		  ' Expands this PKAABB by half the given expansion in each direction and
		  ' then returns this PKAABB.
		  '
		  ' The expansion can be negative to shrink the PKAABB.  However, if the expansion is
		  ' greater than the current width/height, the PKAABB can become invalid.  In this 
		  ' case, the PKAABB will become a degenerate PKAABB at the mid point of the min and max for 
		  ...
		  // We only need to verify the new PKAABB if the expansion was inwardly.
		  If expansion < 0 Then
	...
	#tag Method, Flags = &h0
		Function GetArea() As Double
		  ///
		  ' Returns the area of this PKAABB.
		  '
		  ' - Returns: Double.
		  ///
	...
	#tag Method, Flags = &h0, Description = 52657475726E732061206E65772041414242206F662074686973204141424220657870616E6465642062792068616C662074686520676976656E20657870616E73696F6E20696E20626F746820746865207820616E64207920646972656374696F6E732E
		Function GetExpanded(expansion As Double) As PKAABB
		  ///
		  ' Returns a new PKAABB of this PKAABB expanded by half the given expansion
	...
	#tag Method, Flags = &h0, Description = 52657475726E732074686520686569676874206F66207468697320414142422E
		Function GetHeight() As Double
		  ///
		  ' Returns the height of this PKAABB.
		  '
		  ' - Returns: Double.
		  ///
	...
	#tag Method, Flags = &h0, Description = 506572666F726D732074686520696E74657273656374696F6E206F662074686973204141424220616E642074686520676976656E20414142422072657475726E696E672074686520726573756C7420696E2061206E657720414142422E
		Function GetIntersection(aabb As PKAABB) As PKAABB
		  ///
		  ' Performs the intersection of this PKAABB and the given PKAABB returning
		  ' the result in a new PKAABB.
		  '
		  ' If the given PKAABB does not overlap this PKAABB, a zero PKAABB is returned.
		  '
		  ' - Parameter aabb: The PKAABB to intersect.
		  '
		  ' - Returns: A new PKAABB.
		  ///
	...
	#tag Method, Flags = &h0
		Function GetPerimeter() As Double
		  ///
		  ' Returns the perimeter of this PKAABB.
		  '
		  ' - Returns: Double.
		  ///
	...
	#tag Method, Flags = &h0, Description = 52657475726E732061206E65772041414242206F6620746869732041414242207472616E736C617465642062792074686520676976656E207472616E736C6174696F6E20616D6F756E742E
		Function GetTranslated(translation As PKVector2) As PKAABB
		  ///
		  ' Returns a new PKAABB of this PKAABB translated by the given translation amount.
		  '
	...
	#tag Method, Flags = &h0, Description = 506572666F726D73206120756E696F6E206F662074686973204141424220616E642074686520676976656E20414142422072657475726E696E672061206E6577204141424220636F6E7461696E696E672074686520726573756C742E
		Function GetUnion(aabb As PKAABB) As PKAABB
		  ///
		  ' Performs a union of this PKAABB and the given PKAABB returning
		  ' a new PKAABB containing the result.
		  '
		  ' - Parameter aabb: The PKAABB to union.
		  '
		  ' - Returns: The resulting union as a new PKAABB.
		  ///
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320746865207769647468206F66207468697320414142422E
		Function GetWidth() As Double
		  ///
		  ' Returns the width of this PKAABB.
		  '
		  ' - Returns: Double.
		  ///
	...
	#tag Method, Flags = &h0, Description = 506572666F726D732074686520696E74657273656374696F6E206F662074686973204141424220616E642074686520676976656E204141424220706C6163696E672074686520726573756C7420696E746F2074686973204141424220616E64207468656E2072657475726E73207468697320414142422E
		Function Intersection(aabb As PKAABB) As PKAABB
		  ///
		  ' Performs the intersection of this PKAABB and the given PKAABB placing
		  ' the result into this PKAABB and then returns this PKAABB.
		  '
		  ' If the given PKAABB does not overlap this PKAABB, this PKAABB is set to a zero PKAABB.
		  '
		  ' - Parameter aabb: The PKAABB to intersect.
		  '
		  ' - Returns: This PKAABB.
		  ...
		  // Check for a bad PKAABB.
		  If Self.minX > Self.maxX Or Self.minY > Self.maxY Then
		    // The two PKAABBs were not overlapping. Set this PKAABB to a degenerate one.
		    Self.MinX = 0.0
		    Self.MinY = 0.0
		    Self.MaxX = 0.0
		    Self.MaxY = 0.0
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320547275652069662074686973204141424220697320646567656E65726174652E
		Function IsDegenerate() As Boolean
		  ///
		  ' Returns True if this PKAABB is degenerate.
		  '
		  ' A degenerate PKAABB is one where its min and max x or y coordinates are equal.
		  '
		  ' - Returns: Boolean.
		  ///
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320547275652069662074686973204141424220697320646567656E657261746520676976656E2074686520737065636966696564206572726F722E
		Function IsDegenerate(error As Double) As Boolean
		  ///
		  ' Returns True if this PKAABB is degenerate given the specified error.
		  '
		  ' a PKAABB is degenerate given some error if:
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320547275652069662074686520676976656E204141424220616E6420746869732041414242206F7665726C61702E
		Function Overlaps(aabb As PKAABB) As Boolean
		  ///
		  ' Returns True if the given PKAABB and this PKAABB overlap.
		  '
		  ' - Parameter aabb: The PKAABB to test.
		  '
		  ' - Returns: Boolean.
	...
	#tag Method, Flags = &h0, Description = 536574732074686973204141424220746F2074686520676976656E204141424227732076616C756520616E642072657475726E73207468697320414142422E
		Function Set(aabb As PKAABB) As PKAABB
		  ///
		  ' Sets this PKAABB to the given PKAABB's value and returns this PKAABB.
		  '
		  ' - Parameter aabb: The PKAABB to copy.
		  '
		  ' - Returns: This PKAABB.
	...
	#tag Method, Flags = &h0, Description = 52657475726E73206120537472696E6720726570726573656E746174696F6E206F662074686973204141424220696E2074686520666F726D61743A2022414142425B4D696E3D28782C79297C4D61783D28782C79295D222E
		Function ToString() As String
		  ///
		  ' Returns a String representation of this PKAABB in the format: "AABB[Min=(x,y)|Max=(x,y)]".
		  ///
	...
	#tag Method, Flags = &h0, Description = 506572666F726D73206120756E696F6E206F662074686973204141424220616E642074686520676976656E204141424220706C6163696E672074686520726573756C74206F662074686520756E696F6E20696E746F2074686973204141424220616E64207468656E2072657475726E73207468697320414142422E
		Function Union(aabb As PKAABB) As PKAABB
		  ///
		  ' Performs a union of this PKAABB and the given PKAABB placing
		  ' the result of the union into this PKAABB and then returns this PKAABB.
		  '
		  ' - Parameter aabb: The PKAABB to union.
		  '
		  ' - Returns: This PKAABB.
	...
	#tag Note, Name = About
		...
		a PKAABB has minimum and maximum coordinates that define the box.
		
		a PKAABB can be unioned or intersected with other PKAABBs to combine them into 
		another PKAABB. If an intersection produces no result, a degenerate PKAABB is returned.
		A degenerate PKAABB can be tested by the `IsDegenerate()` methods and 
		is defined as a PKAABB who's maximum and minimum are equal.
		
		AABBs can also be tested for overlap and (full) containment using the `Overlaps(AABB)`
		and `Contains(AABB)` method.
		
		The `Expand(Double)` method can be used to expand the bounds of the PKAABB by some amount.
