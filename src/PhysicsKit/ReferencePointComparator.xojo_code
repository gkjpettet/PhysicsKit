...
Protected Class ReferencePointComparator
	#tag Method, Flags = &h0
		Function Compare(p1 As PhysicsKit.Vector2, p2 As PhysicsKit.Vector2) As Integer
	...
	#tag Method, Flags = &h0
		Sub Constructor(reference As PhysicsKit.Vector2)
		  ///
		  ' Full constructor.
		  '
	...
	#tag Property, Flags = &h0, Description = 546865207265666572656E636520706F696E7420666F722074657374696E6720706F6C617220616E676C65732E
		Reference As PhysicsKit.Vector2
	#tag EndProperty
