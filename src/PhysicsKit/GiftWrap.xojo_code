...
Implements PhysicsKit.HullGenerator
	#tag Method, Flags = &h0
		Function Generate(points() As PhysicsKit.Vector2) As PhysicsKit.Vector2()
		  ...
		  Var leftMost As Vector2
		  Var iLimit As Integer = size - 1
		  For i As Integer = 0 To iLimit
		    Var p As Vector2 = points(i)
		    ...
		    For j As Integer = 1 To jLimit
		      ...
		      ElseIf location = 0 Then
		        ...
		        Else
		          ...
		          Var l1 As Vector2 = current.Towards(nextPoint)
		          Var l2 As Vector2 = nextPoint.Towards(test)
