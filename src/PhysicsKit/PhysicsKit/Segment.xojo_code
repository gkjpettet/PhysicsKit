...
Implements PhysicsKit.Convex,PhysicsKit.Wound
		...
		Function Contains(point As PKVector2, transform As PKTransform, radius As Double) As Boolean
		  ...
		  Else
		    ...
		    Else
		      ...
		      Var l As PKVector2 = Self.Vertices(0).Towards(Self.Vertices(1))
		      Var p1 As PKVector2 = Self.Vertices(0).Towards(p)
		      Var p2 As PKVector2 = Self.Vertices(1).Towards(p)
	...
	#tag Method, Flags = &h0
		Function GetAxes(foci() As PKVector2, transform As PKTransform) As PKVector2()
		  ...
		  // Get the vertices.
		  Var p1 As PKVector2 = transform.GetTransformed(Self.Vertices(0))
		  Var p2 As PKVector2 = transform.GetTransformed(Self.Vertices(1))
	...
	#tag Method, Flags = &h0, Description = 
		Shared Function GetFarthestFeature(v1 As PKVector2, v2 As PKVector2, vector As PKVector2, transform As PKTransform) As PhysicsKit.EdgeFeature
		  ...
		  Var max As PKVector2 = Nil
		  
		  // Get the vertices.
		  Var p1 As PKVector2 = transform.GetTransformed(v1)
		  Var p2 As PKVector2 = transform.GetTransformed(v2)
	...
	#tag Method, Flags = &h0, Description = 
		Function GetLineIntersection(segment As PhysicsKit.Segment) As PKVector2
		  ...
		  ' 
		  ' - Returns: PKVector2 or Nil if the lines are parallel or coincident.
		  '
	...
	#tag Method, Flags = &h0, Description = 52657475726E732074686520696E74657273656374696F6E20706F696E74206F66207468652074776F206C696E6573206F72204E696C20696620746865792061726520706172616C6C656C206F7220636F696E636964656E742E205468726F7773204E696C4F626A656374457863657074696F6E2E
		Shared Function GetLineIntersection(ap1 As PKVector2, ap2 As PKVector2, bp1 As PKVector2, bp2 As PKVector2) As PKVector2
		  ///
		  ...
		  '
		  ' - Returns: The intersection point as a PKVector2 or Nil if the lines are parallel or coincident.
		  '
		  ' - Raises: NilObjectException if `ap1`, `ap2`, `bp1` or `bp2` is Nil.
		  ///
		  
		  Var A As PKVector2 = ap1.Towards(ap2)
		  Var B As PKVector2 = bp1.Towards(bp2)
	...
	#tag Method, Flags = &h0, Description = 44657465726D696E65732077686572652074686520706F696E742069732072656C617469766520746F2074686520676976656E206C696E652E205468726F7773204E696C4F626A656374457863657074696F6E2E
		Shared Function GetLocation(point As PKVector2, linePoint1 As PKVector2, linePoint2 As PKVector2) As Double
		  ///
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320706F696E743120696E206C6F63616C20636F6F7264696E617465732E
		Function GetPoint1() As PKVector2
		  ///
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320706F696E743220696E206C6F63616C20636F6F7264696E617465732E
		Function GetPoint2() As PKVector2
		  ///
	...
	#tag Method, Flags = &h0, Description = 
		Function GetPointOnLineClosestToPoint(point As PKVector2) As PKVector2
		  ///
	...
	#tag Method, Flags = &h0, Description = 52657475726E732074686520706F696E74206F6E2074686520676976656E206C696E6520636C6F7365737420746F2074686520676976656E20706F696E742E205468726F7773204E696C4F626A656374457863657074696F6E2E
		Shared Function GetPointOnLineClosestToPoint(point As PKVector2, linePoint1 As PKVector2, linePoint2 As PKVector2) As PKVector2
		  ///
		  ...
		  Var p1ToP As PKVector2 = point.Difference(linePoint1)
		  
		  // Create a vector representing the line.
		  Var line As PKVector2 = linePoint2.Difference(linePoint1)
	...
	#tag Method, Flags = &h0, Description = 
		Function GetPointOnSegmentClosestToPoint(point As PKVector2) As PKVector2
		  ///
	...
	#tag Method, Flags = &h0, Description = 
		Shared Function GetPointOnSegmentClosestToPoint(point As PKVector2, linePoint1 As PKVector2, linePoint2 As PKVector2) As PKVector2
		  ///
	...
	#tag Method, Flags = &h0, Description = 
		Function GetSegmentIntersection(segment As PhysicsKit.Segment) As PKVector2
		  ...
		  ' - Parameter segment: The other segment.
		  '
		  ' - Returns: PKVector2 or Nil (if the segments do not intersect, are parallel, or are coincident).
		  '
		  ' - Raises: NilObjectException if the given segment is Nil.
		  ///
	...
	#tag Method, Flags = &h0, Description = 
		Shared Function GetSegmentIntersection(ap1 As PKVector2, ap2 As PKVector2, bp1 As PKVector2, bp2 As PKVector2) As PKVector2
		  ///
		  ...
		  '
		  ' - Returns: The intersection point as a PKVector2 or 
		  ...
		  // Compute the intersection point.
		  Var ip As PKVector2 = B.Product(tb).Add(bp1)
	...
	#tag Method, Flags = &h21, Description = 56616C6964617465732074686520636F6E7374727563746F7220696E7075742072657475726E696E6720547275652069662076616C6964206F72207468726F77696E6720616E20657863657074696F6E20696620696E76616C69642E
		Private Shared Function Validate(point1 As PKVector2, point2 As PKVector2) As Boolean
		  ///
