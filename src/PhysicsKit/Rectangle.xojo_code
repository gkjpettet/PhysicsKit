...
Inherits PhysicsKit.Polygon
	#tag Method, Flags = &h21, Description = 56616C69646174656420636F6E7374727563746F722E205468652063656E747265206F66207468652072656374616E676C652077696C6C20626520746865206F726967696E2E
		Private Sub Constructor(valid As Boolean, width As Double, height As Double, vertices() As PhysicsKit.Vector2)
		  ///
	...
	#tag Method, Flags = &h0
		Function Contains(point As PhysicsKit.Vector2, transform As PhysicsKit.Transform) As Boolean
		  ...
		  Var projectAxis0 As Vector2 = p1.Towards(p2)
		  Var projectAxis1 As Vector2 = p1.Towards(p4)
		  
		  // Create a vector from the centroid to the point.
		  Var toPoint As Vector2 = c.Towards(p)
	...
	#tag Method, Flags = &h0
		Function GetAxes(foci() As PhysicsKit.Vector2, transform As PhysicsKit.Transform) As PhysicsKit.Vector2()
		  ...
		  For Each focus As Vector2 In foci
		    ...
		    For j As Integer = 1 To 3
		      // get the vertex
		      Var vertex As Vector2 = Self.Vertices(j)
		    ...
		    Var axis As Vector2 = focus.Towards(closest)
		    // Normalise the axis.
		    Call axis.Normalise
		    // Add it to the array.
		    axes.AddRow(axis)
	...
	#tag Method, Flags = &h0, Description = 52657475726E732074686520526F746174696F6E206F626A656374207468617420726570726573656E747320746865206C6F63616C20726F746174696F6E2E
		Function GetRotation() As PhysicsKit.Rotation
		  ...
		  Return New Rotation(Self.Normals(1).X, Self.Normals(1).Y)
	...
	#tag Method, Flags = &h0
		Function Project(vector As PhysicsKit.Vector2, transform As PhysicsKit.Transform) As PhysicsKit.Interval
		  ...
		  Var projectAxis0 As Vector2 = transform.GetTransformedR(Self.Normals(1))
		  Var projectAxis1 As Vector2 = transform.GetTransformedR(Self.Normals(2))
