...
Implements PhysicsKit.Convex
	#tag Method, Flags = &h0
		Sub Constructor(valid As Boolean, width As Double, height As Double, center As PhysicsKit.Vector2, vertexLeft As PhysicsKit.Vector2, vertexRight As PhysicsKit.Vector2)
		  ///
		  ...
		  Self.EllipseCenter = New Vector2
	...
	#tag Method, Flags = &h0
		Sub Constructor(width As Double, height As Double)
		  ...
		  width, _
		  height, _
		  New Vector2(0, (4.0 * height) / (3.0 * MathsKit.PI)), _
		  New Vector2(-width * 0.5, 0), _
	...
	#tag Method, Flags = &h0
		Function Contains(point As PhysicsKit.Vector2, transform As PhysicsKit.Transform) As Boolean
		  ...
		  Var localPoint As Vector2 = transform.GetInverseTransformed(point)
	...
	#tag Method, Flags = &h0
		Function CreateAABB(transform As PhysicsKit.Transform) As PhysicsKit.AABB
		  ...
		  Var u As Vector2 = Self.Rotation.ToVector
	...
	#tag Method, Flags = &h0
		Function GetEllipseCenter() As PhysicsKit.Vector2
		  ///
	...
	#tag Method, Flags = &h0
		Function GetFarthestFeature(vector As PhysicsKit.Vector2, transform As PhysicsKit.Transform) As PhysicsKit.Feature
		  ...
		  Var localAxis As Vector2 = transform.GetInverseTransformedR(vector)
		  ...
		  Else
		    ...
		    Var p1 As Vector2 = transform.GetTransformed(Self.VertexLeft)
		    Var p2 As Vector2 = transform.GetTransformed(Self.VertexRight)
	...
	#tag Method, Flags = &h21, Description = 4D6F6469666965732074686520676976656E206C6F63616C207370616365206178697320696E746F2074686520666172746865737420706F696E7420616C6F6E672074686174206178697320616E64206164646974696F6E616C6C792072657475726E732069742E
		Private Function GetFarthestPoint(localAxis As PhysicsKit.Vector2) As PhysicsKit.Vector2
		  ///
	...
	#tag Method, Flags = &h21, Description = 52657475726E732074686520666172746865737420706F696E7420616C6F6E672074686520676976656E206C6F63616C207370616365206178697320617373756D696E672074686520656C6C6970736520616E642074686520676976656E20617869732061726520616C69676E65642E
		Private Sub GetFarthestPointOnAlignedEllipse(localAxis As PhysicsKit.Vector2)
		  ///
	...
	#tag Method, Flags = &h21
		Private Function GetMaxDistanceEllipse(point As PhysicsKit.Vector2) As Double
		  ///
		  ...
		  Var p As Vector2 = point.Difference(Self.EllipseCenter).InverseRotate(Self.Rotation)
		  
		  // Get the farthest point.
		  Var fp As Vector2 = Ellipse.GetFarthestPointOnEllipse(Self.HalfWidth, Self.Height, p)
	...
	#tag Method, Flags = &h21
		Private Function GetMaxDistanceHalfEllipse(point As PhysicsKit.Vector2) As Double
		  ///
		  ...
		  Var s As Vector2 = Ellipse.GetFarthestPointOnBoundedEllipse(xmin, xmax, a, b, p)
	...
	#tag Method, Flags = &h21
		Private Function GetMaxDistanceToVertices(point As PhysicsKit.Vector2) As Double
		  ///
	...
	#tag Method, Flags = &h0
		Function Project(vector As PhysicsKit.Vector2, transform As PhysicsKit.Transform) As PhysicsKit.Interval
		  ...
		  Var p1 As Vector2 = Self.GetFarthestPoint(vector, transform)
		  Var p2 As Vector2 = Self.GetFarthestPoint(vector.GetNegative, transform)
	...
	#tag Property, Flags = &h0, Description = 54686520656C6C697073652063656E7472652E
		EllipseCenter As PhysicsKit.Vector2
	#tag EndProperty
